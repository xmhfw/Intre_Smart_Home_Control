...
INTREIOT_ROOT_PATH: str = path.dirname(path.abspath(__file__))


def gen_absolute_path(relative_path: str) -> str:
    """Generate an absolute path."""
    return path.join(INTREIOT_ROOT_PATH, relative_path)
...
class IntreIoTMatcher(MQTTMatcher):
    """IntreIoT Pub/Sub topic matcher."""
